...
public class MatrixUtilities {
    ...
    public static String createSerializableMicronToVox(double[] voxelMicrometers, int[] origin) {
        ...
        String micronToVoxString = MatrixUtilities.serializeMatrix(micronToVoxMatrix, EntityConstants.ATTRIBUTE_MICRON_TO_VOXEL_MATRIX);
    ...
    public static String createSerializableVoxToMicron(double[] voxelMicrometers, int[] origin) {
        ...
        String voxToMicronString = MatrixUtilities.serializeMatrix(voxToMicronMatrix, EntityConstants.ATTRIBUTE_VOXEL_TO_MICRON_MATRIX);
