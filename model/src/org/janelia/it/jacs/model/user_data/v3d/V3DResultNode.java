...
package org.janelia.it.jacs.model.user_data.v3d;
 ...
 * Time: 3:32:11 PM
 */
public class V3DResultNode extends FileNode implements IsSerializable, Serializable {

    /**
     * constructor
     */
    public V3DResultNode() {
    }

    public V3DResultNode(String owner, Task task, String name, String description, String visibility, String relativeSessionPath) {
