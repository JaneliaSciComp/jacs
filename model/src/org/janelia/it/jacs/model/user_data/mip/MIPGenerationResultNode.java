 ...
 * User: cgoina
 */
public class MIPGenerationResultNode extends FileNode implements IsSerializable, Serializable {

    /**
     * constructor
     */
    public MIPGenerationResultNode() {
    }

    public MIPGenerationResultNode(String owner, Task task, String name, String description, String visibility, String relativeSessionPath) {
