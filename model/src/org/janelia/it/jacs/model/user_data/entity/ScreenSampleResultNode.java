 ...
 * Time: 3:32:11 PM
 */
public class ScreenSampleResultNode extends FileNode implements IsSerializable, Serializable {

    /**
     * constructor
     */
    public ScreenSampleResultNode() {
    }

    public ScreenSampleResultNode(String owner, Task task, String name, String description, String visibility,
