package org.janelia.it.jacs.model.user_data.neuron;

/**
 * Created by schauderd on 5/11/16.
 */
 ...
 * User: schauderd
 */
public class NeuronLineageClassifierResultNode extends FileNode implements IsSerializable, Serializable {

    /**
     * constructor
     */
    public NeuronLineageClassifierResultNode() {
    }

    public NeuronLineageClassifierResultNode(String owner, Task task, String name, String description, String visibility,
