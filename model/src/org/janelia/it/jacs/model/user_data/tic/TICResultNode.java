package org.janelia.it.jacs.model.user_data.tic;
 ...
 * Time: 3:32:11 PM
 */
public class TICResultNode extends FileNode implements IsSerializable, Serializable {

    /**
     * constructor
     */
    public TICResultNode() {
    }

    public TICResultNode(String owner, Task task, String name, String description, String visibility, String relativeSessionPath) {
