...
/**
 * A generic file node that uses its name as the directory name.
 * 
 * @author <a href="mailto:rokickik@janelia.hhmi.org">Konrad Rokicki</a>
 */
public class NamedFileNode extends FileNode implements IsSerializable, Serializable {

    /**
     * constructor
     */
    public NamedFileNode() {
    }

    public NamedFileNode(String owner, Task task, String name, String description, String visibility, String relativeSessionPath) {
