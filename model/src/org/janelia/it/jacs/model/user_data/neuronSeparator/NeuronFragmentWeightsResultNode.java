 ...
 * User: schauderd
 */
public class NeuronFragmentWeightsResultNode extends FileNode implements IsSerializable, Serializable {

    /**
     * constructor
     */
    public NeuronFragmentWeightsResultNode() {
    }

    public NeuronFragmentWeightsResultNode(String owner, Task task, String name, String description, String visibility,
