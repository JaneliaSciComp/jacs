package org.janelia.it.jacs.model.user_data.zlatic;
 ...
 * Time: 3:32:11 PM
 */
public class ZlaticLabResultNode extends FileNode implements IsSerializable, Serializable {

    /**
     * constructor
     */
    public ZlaticLabResultNode() {
    }

    public ZlaticLabResultNode(String owner, Task task, String name, String description, String visibility, String relativeSessionPath) {
