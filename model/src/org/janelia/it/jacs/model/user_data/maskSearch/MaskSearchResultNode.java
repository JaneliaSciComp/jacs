...
package org.janelia.it.jacs.model.user_data.maskSearch;
...
public class MaskSearchResultNode extends FileNode implements IsSerializable, Serializable {
    ...
    public static final String TAG_RESULTS  = "searchResults.txt";

    /**
     * constructor
     */
    public MaskSearchResultNode() {
    }

    public MaskSearchResultNode(String owner, Task task, String name, String description, String visibility,
