...
import org.janelia.it.jacs.model.domain.interfaces.imaging.MaskedVolume;
import org.janelia.it.jacs.model.domain.interfaces.imaging.Neuron;
import org.janelia.it.jacs.model.domain.interfaces.imaging.Sample;
...
import org.janelia.it.jacs.model.domain.interfaces.imaging.Viewable4d;
import org.janelia.it.jacs.model.domain.interfaces.metamodel.RelationshipLoader;
import org.janelia.it.jacs.model.entity.Entity;
import org.janelia.it.jacs.model.entity.EntityConstants;

public class EntitySample extends EntityDomainObject implements Sample, Viewable2d, Viewable3d, Viewable4d {

    private String imagePathFast3d;
    private List<Neuron> neuronSet;
    private EntityVolumeImage reference;
    private MaskedVolume maskedVolume;

    public EntitySample(Entity entity) {
        super(entity);
    }
...
//        List<EntityAlignmentContext> contexts = new ArrayList<EntityAlignmentContext>();
//        
...
//                                contexts.add(new EntityAlignmentContext(alignmentSpaceName, opticalResolution, pixelResolution));
//                            }
//                        }
//                    }
//                }
...
//        ModelMgr.getModelMgr().loadLazyEntity(getInternalEntity(), false);
//        
//        this.neuronSet = new ArrayList<EntityNeuron>();
//        
...
//                    	        			reference = new EntityVolumeImage(image3d);
//                    	        		};
//                    	        	}
//                    	        	
//                    	        	if (reference==null) {
...
//        
//        if (separation!=null) {
//            maskedVolume = new EntityMaskedVolume(separation.getValueByAttributeName(EntityConstants.ATTRIBUTE_FILE_PATH));
...
//                    EntityNeuron neuron = new EntityNeuron(neuronFragment);
...
//            setAlignmentContext(new EntityAlignmentContext(matchedAlignmentSpace, matchedOpticalRes, matchedPixelRes));
//            // Sanity check
...
//        }
    ...
    public String getDataSetIdentifier() {
        return getAttributeValue(EntityConstants.ATTRIBUTE_DATA_SET_IDENTIFIER);
    }

    public String getChannelSpecification() {
        return getAttributeValue(EntityConstants.ATTRIBUTE_CHANNEL_SPECIFICATION);
    }

    public String getTilingPattern() {
        return getAttributeValue(EntityConstants.ATTRIBUTE_TILING_PATTERN);
    }
    ...
    public String get3dImageFilepath() {
        return getAttributeValue(EntityConstants.ATTRIBUTE_DEFAULT_3D_IMAGE);
    }
    ...
    public EntityVolumeImage getReference() {
    	return reference;
    }
