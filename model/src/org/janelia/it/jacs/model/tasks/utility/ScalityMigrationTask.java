 ...
 * Time: 10:08:35 AM
 */
public class ScalityMigrationTask extends Task {

    public static final String DISPLAY_NAME = "Scality Migration Task";
    public static final String PARAM_SOURCE = "sourcePath";

    public ScalityMigrationTask() {
        super();
    }

    public ScalityMigrationTask(String owner,
                                List<Event> events,
                                String sourcePath) {
