 ...
 * Time: 10:00:33 AM
 */
public class UploadGtfFileTask extends Task {

    public static final String DISPLAY_NAME = "Upload Gtf File Task";
    public static final String PARAM_SOURCE_FILE = "sourceFile";

    public UploadGtfFileTask() {
        super();
        commonConstructor();
    }

    public UploadGtfFileTask(Set<Node> inputNodes, String owner, List<Event> events, Set<TaskParameter> taskParameterSet,
