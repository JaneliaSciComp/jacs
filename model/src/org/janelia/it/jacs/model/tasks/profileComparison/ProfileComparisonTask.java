...
package org.janelia.it.jacs.model.tasks.profileComparison;
 ...
 */
public class ProfileComparisonTask extends Task {
    transient public static final String TASK_NAME = "profileComparison";
    transient public static final String DISPLAY_NAME = "Profile Comparison";
    ...
    public ProfileComparisonTask(Set<Node> inputNodes, String owner, List<Event> events, Set<TaskParameter> taskParameterSet) {
        super(inputNodes, owner, events, taskParameterSet);
        setDefaultValues();
    }

    public ProfileComparisonTask() {
        setDefaultValues();
    }
