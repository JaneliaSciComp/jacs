...
public class TimebasedIdentifierGenerator implements IdentifierGenerator {
    ...
    static Logger logger = Logger.getLogger(TimebasedIdentifierGenerator.class.getName());
    ...
    static {
        try {
            ...
            valid = false;
            logger.error("Exception starting up TimebasedIdentifierGenerator.", t);
            //t.printStackTrace();
        }
    }
...
//        long nTimeStart = System.nanoTime();
        ...
        try {
            ...
            valid = false;
            logger.error("Exception within TimebasedIdentifierGenerator: " + t.toString(), t);
            //t.printStackTrace();
...
//                props.getProperty(PROFILE_PROP).toLowerCase().equals("true")) doLog=true;
        ...
        if (deploymentContext < 0 || deploymentContext > 255) {
            logger.error("Deployment context " + deploymentContext + " out of range");
            valid = false;
        }
