...
package org.janelia.it.jacs.compute.launcher.neuronSeparator;
 ...
 * @author Tareq Nabeel
 */
@MessageDriven(name = "NeuronSeparatorPipelineLocalLauncherMDB", activationConfig = {
        @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge "),
        @ActivationConfigProperty(propertyName = "messagingType", propertyValue = "javax.jms.MessageListener"),
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
        @ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/neuronSeparatorPipelineLocalLauncher"),
...
public class NeuronSeparatorPipelineLocalLauncherMDB extends SeriesLauncherMDB {
