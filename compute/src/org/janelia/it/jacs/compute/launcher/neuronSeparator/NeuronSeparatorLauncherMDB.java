...
@MessageDriven(name = "NeuronSeparatorLauncherMDB", activationConfig = {
        ...
        @ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/neuronSeparatorLauncher"),
...
public class NeuronSeparatorLauncherMDB extends SeriesLauncherMDB {
