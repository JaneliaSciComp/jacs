...
package org.janelia.it.jacs.compute.launcher.colorSeparator;
 ...
 * @author Tareq Nabeel
 */
@MessageDriven(name = "ColorSeparatorLauncherMDB", activationConfig = {
        @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge "),
        @ActivationConfigProperty(propertyName = "messagingType", propertyValue = "javax.jms.MessageListener"),
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
        @ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/colorSeparatorLauncher"),
...
public class ColorSeparatorLauncherMDB extends SeriesLauncherMDB {
