...
public class WorkstationDataManager implements WorkstationDataManagerMBean {
    ...
    public void createPatternAnnotationQuantifierSummaryFile() {
        try {
//            Map<Entity, Map<String, Double>> entityQuantifierMap=
                    EJBFactory.getLocalAnnotationBean().getPatternAnnotationQuantifiers();
    ...
    public void runDataDeDuplication() {
        ...
        try {
            ...
            TreeMap<Integer,ArrayList<SampleRun>> systemMap = new TreeMap<>();
            TreeMap<Integer,ArrayList<SampleRun>> wolfftMap = new TreeMap<>();
        ...
        catch (ComputeException | IOException e) {
            e.printStackTrace();
        }
    }
