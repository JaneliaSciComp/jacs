...
import org.janelia.it.jacs.shared.dma.formatdb.CreateBlastDatabaseFromFastaTool;
import org.janelia.it.jacs.shared.dma.formatdb.FormatDBTool;
...
public class FileNodeManager implements FileNodeManagerMBean {
    ...
    protected void createBlastableDatabase(String name, String description, String sourcePath, String type) {
        ...
        try {
            ...
            bdfn.setDataSource(DataSource.CAMERA);
