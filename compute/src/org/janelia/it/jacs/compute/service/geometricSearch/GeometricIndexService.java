...
public class GeometricIndexService extends AbstractEntityService {
    ...
    protected void execute() throws Exception {
        ...
        VisitorFactory alignmentResourceFactory=new VisitorFactory(parameterMap, AlignmentResourceVisitor.class);
        VisitorFactory alignmentIndexValidationFactory=new VisitorFactory(parameterMap, AlignmentIndexValidationVisitor.class);
        VisitorFactory alignmentIndexFactory=new VisitorFactory(parameterMap, AlignmentIndexVisitor.class);
        ...
        geometricIndexVisitors.add(alignmentResourceFactory);
        geometricIndexVisitors.add(alignmentIndexValidationFactory);
        geometricIndexVisitors.add(alignmentIndexFactory);
