 ...
 * Time: 7:33 PM
 */
public class Vaa3DMaskAnnotationService extends SubmitDrmaaJobService {

    List<String> sampleIdList;
    List<String> sampleNameList;
    List<String> maskAnnotationPathList;
    ...
    protected void init(IProcessData processData) throws Exception {
        ...
        maskAnnotationPathList=(List<String>)processData.getItem("MASK_ANNOTATION_PATH");
        ...
        if (sampleNameList==null) {
            logger.info("Vaa3DMaskAnnotationService init() sampleName list is null");
        } else {
            logger.info("Vaa3DMaskAnnotationService init() sampleName list contains "+sampleNameList.size()+" entries");
        }
    ...
    protected void createJobScriptAndConfigurationFiles(FileWriter writer) throws Exception {
        int configIndex = 1;
        logger.info("Vaa3DMaskAnnotationService createJobScriptAndConfigurationFiles() start");
        for(String sampleName : sampleNameList) {
            logger.info("Vaa3DMaskAnnotationService createJobScriptAndConfigurationFiles() sampleName="+sampleName);
            String patternAnnotationPath = maskAnnotationPathList.get(configIndex-1);
