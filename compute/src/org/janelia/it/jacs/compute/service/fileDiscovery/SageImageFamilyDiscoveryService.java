...
public class SageImageFamilyDiscoveryService extends AbstractEntityService {
    ...
    private Entity createOrUpdateSample(String sampleName, String dataSetIdentifier, TilingPattern tiling, 
    	...
    	Entity sample = superCreateOrUpdateSample(sampleName, dataSetIdentifier, sampleTileGroupList);
    	updateSampleTilingPattern(sample, tiling);
    	return sample;
    }

    protected Entity superCreateOrUpdateSample(String sampleIdentifier, String dataSetIdentifier, 
            List<ImageTileGroup> tileGroupList) throws Exception {
