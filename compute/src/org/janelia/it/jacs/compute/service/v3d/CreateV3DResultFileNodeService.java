...
import org.janelia.it.jacs.model.user_data.v3d.V3DResultNode;
 ...
 * @author Todd Safford
 */
public class CreateV3DResultFileNodeService implements IService {

    private Task task;
    private V3DResultNode resultFileNode;
    ...
    private Long createResultFileNode() throws DaoException, IOException {
        ...
        resultFileNode = new V3DResultNode(task.getOwner(), task,
                "V3DResultNode",
                "V3DResultNode for createtask " + task.getObjectId(), visibility, sessionName);
