 ...
 * Time: 10:43:26 AM
 */
public class PsiBlastMergeService implements IService {

    private List<File> queryFiles;
    private Map<File, List<File>> inputOutputFileListMap;
    private PsiBlastResultNode resultFileNode;
    ...
    protected void init(IProcessData processData) throws MissingDataException, IOException {
        ...
        resultFileNode = (PsiBlastResultNode) ProcessDataHelper.getResultFileNode(processData);
...
//            PsiBlastDatabaseNode dbNode = (PsiBlastDatabaseNode) computeDAO.genericLoad(PsiBlastDatabaseNode.class, dbNodeId);
//            databaseName=getNameFromNode(dbNode);
    ...
    private void mergeResultFiles() throws Exception {
        File resultFile = new File(resultFileNode.getFilePathByTag(PsiBlastResultNode.TAG_TEXT_OUTPUT));
