...
public class GridResourceSpec {
	 ...
	 * @return
	 */
	public GridResourceSpec(int requiredMemoryInGB, int requiredSlots, boolean isExclusive) {
...
//    	}
    ...
    private static String getSpec(int requiredMemoryInGB, int requiredSlots, boolean isExclusive) {
        GridResourceSpec spec = new GridResourceSpec(requiredMemoryInGB, requiredSlots, isExclusive);
