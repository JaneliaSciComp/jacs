 ...
 * @author Todd Safford
 */
public class CreateAP16SResultFileNodeService implements IService {

    private Task task;
    private AnalysisPipeline16SResultNode resultFileNode;
    ...
    private Long createResultFileNode() throws DaoException, IOException {
        ...
        resultFileNode = new AnalysisPipeline16SResultNode(task.getOwner(), task,
                "AnalysisPipeline16SResultNode",
                "AnalysisPipeline16SResultNode for createtask " + task.getObjectId(), visibility, sessionName);
