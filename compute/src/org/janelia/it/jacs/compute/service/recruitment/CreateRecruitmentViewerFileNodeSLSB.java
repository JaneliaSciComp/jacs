...
public class CreateRecruitmentViewerFileNodeSLSB extends BaseServiceSLSB {
    public IService getService(IProcessData
            processData) {
        return new org.janelia.it.jacs.compute.service.recruitment.CreateRecruitmentFileNodeService();
    }
}