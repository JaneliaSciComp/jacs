function [TS_rec Q_all] = TxSite_reconstruct_w_image_FUN_v2(img_TS,img_bgd,img_PSF,parameters)
...
for iP = 2:N_mRNA_MAX
     ...
     %== Calculate next PSF
     results_placement = PSF_place_image_v4(data_images,parameters);
...
%Q_min                 = [Q_all(Q_min_ind,1) Q_min_val];
