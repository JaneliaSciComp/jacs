function [spots_fit FIT_Result] = spots_fit_batch_3D_Gauss_v6(spots_detected,sub_spots,parameters)
...
if N_Spots
    ...
    if (flag_struct.parallel)
        parfor k = 1:N_Spots
            FIT_Result{k} = psf_fit_3d_v6(sub_spots{k},[],options_fit,flag_struct);
        end
