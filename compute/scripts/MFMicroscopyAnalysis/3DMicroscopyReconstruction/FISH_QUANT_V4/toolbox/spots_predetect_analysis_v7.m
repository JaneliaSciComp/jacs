function  [spots_detected_th spots_detected detect_threshold_score sub_spots sub_spots_filt] = spots_predetect_analysis_v7(image_struct,img_mask,spots_detected_pos,options,flag_struct)
...
if N_Spots
    ...
    spots_detected(:,12)   = 1;                      %- Thresholded or not (based on quality score)    
