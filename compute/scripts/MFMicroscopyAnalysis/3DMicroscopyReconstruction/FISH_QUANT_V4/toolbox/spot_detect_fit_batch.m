function [cell_prop par_microscope file_name_image file_name_image_filtered] = spot_detect_fit_batch(handles,parameters)
...
use_filtered = handles.checkbox_use_filtered;
...
save_filtered = handles.checkbox_save_filtered;
