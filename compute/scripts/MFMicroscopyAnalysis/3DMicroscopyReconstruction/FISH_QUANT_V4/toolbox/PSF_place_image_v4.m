function results = PSF_place_image_v4(data_images,parameters)
...
if flags.psf == 1
    ...
    factor_scale = amp_loop/img_PSF_all(1).PSF_fit.amp;    
...
elseif flags.psf == 2
   ...
   ind_min         = ind_min(1);      
   par_shift_best  = img_PSF_all(i_PSF).par_shift;
end


%=== Assign ouput
results.Q_min            = Q_min;
results.Q_min_in         = ind_min;
