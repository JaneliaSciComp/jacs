...
test_runCddSearch.pl - test the runCddSearch web-service call.

=head1 SYNOPSIS

    USAGE: test_runCddSearch.pl OPTION LIST HERE
...
This script tests the runCddSearch web service, invoking with the username
...
my @options = ( $username,              # username
                ...
                $rpsblast_options,      # rpsblast_options
