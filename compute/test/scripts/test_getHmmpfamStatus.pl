...
test_getHmmpfamStatus.pl - test the getHmmpfamStatus web-service call.

=head1 SYNOPSIS

    USAGE: test_getHmmpfamStatus.pl OPTION LIST HERE
...
=head1 OPTIONS
 ...
 --taskId       VICS job id as returned by runHmmpfam

=head1  DESCRIPTION

This script tests the getHmmpfamStatus web service.
