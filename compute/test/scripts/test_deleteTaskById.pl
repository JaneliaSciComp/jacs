...
test_deleteTaskById.pl - test the deleteTaskById web-service call.

=head1 SYNOPSIS

    USAGE: test_deleteTaskById.pl OPTION LIST HERE
...
=head1 OPTIONS
 ...
 --taskId       VICS job id to delete

=head1  DESCRIPTION

This script tests the deleteTaskById web service.
...
Task=1448381754682378411 and all subtasks successfully deleted
