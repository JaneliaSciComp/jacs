...
test_runInterProScan.pl - test the runInterProScan web-service call.

=head1 SYNOPSIS

    USAGE: test_runInterProScan.pl OPTION LIST HERE
...
This script tests the runInterProScan web service, invoking with the username
