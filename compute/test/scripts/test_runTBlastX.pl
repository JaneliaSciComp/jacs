...
test_runTBlastX.pl - test the runTBlastX web-service call.

=head1 SYNOPSIS

    USAGE: test_runTBlastX.pl OPTION LIST HERE
...
This script tests the runTBlastX web service.
