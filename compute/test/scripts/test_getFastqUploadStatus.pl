...
test_getFastqUploadStatus.pl - test the getFastqUploadStatus web-service call.

=head1 SYNOPSIS

    USAGE: test_getFastqUploadStatus.pl OPTION LIST HERE
...
This script tests the getFastqUploadStatus web service.
...
my $program = 'getFastqUploadStatus';
