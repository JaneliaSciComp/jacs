...
test_runPriam.pl - test the runPriam web-service call.

=head1 SYNOPSIS

    USAGE: test_runPriam.pl OPTION LIST HERE
...
This script tests the runPriam web service, invoking with the username
