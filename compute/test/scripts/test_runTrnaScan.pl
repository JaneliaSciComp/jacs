...
test_runTrnaScan.pl - test the runTrnaScan web-service call.

=head1 SYNOPSIS

    USAGE: test_runTrnaScan.pl OPTION LIST HERE
...
=head1 OPTIONS
 ...
 --project          The grid-charging code to be used [08020]
 --workSessionId    Work session id if this is to be part of one
 --jobName          How to identify this job [TestTrnaScan]
 --inputFastaFileNodeId     VICS id for the input set
 --searchType       
 --options
...
This script tests the runTrnaScan web service, invoking with the username
