...
=head1 OPTIONS
 ...
 --taskId       VICS job id as returned by runPriam

=head1  DESCRIPTION

This script tests the getPriamStatus web service.
...
Status Type: running
Status Description: Starting sequence BlastSubmitJob

or (if the blast job is finished):
