...
test_runTBlastN.pl - test the runTBlastN web-service call.

=head1 SYNOPSIS

    USAGE: test_runTBlastN.pl OPTION LIST HERE
...
=head2 VICS parameters
 ...
 --jobName          Name to identify the job [TestTBlastN]
...
This script tests the runTBlastN web service.
