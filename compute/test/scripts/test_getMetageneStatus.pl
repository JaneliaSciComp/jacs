...
test_getMetageneStatus.pl - test the getMetageneStatus web-service call.

=head1 SYNOPSIS

    USAGE: test_getMetageneStatus.pl OPTION LIST HERE
...
This script tests the getMetageneStatus web service.
