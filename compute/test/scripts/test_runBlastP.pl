...
test_runBlastP.pl - test the runBlastP web-service call.

=head1 SYNOPSIS

    USAGE: test_runBlastP.pl OPTION LIST HERE
...
=head2 VICS parameters
 ...
 --subjectDBIdentifier  VICS db identifier for the subject db [1438256871256361131]
 --queryFastaFileNodeId VICS identifier for the query fasta [1438259906372176043]
...
This script tests the runBlastP web service.
...
my $project = '08020';
my $workSessionId = '';
my $jobName = 'TestBlastP';
my $subjectDBIdentifier = '1438256871256361131';
my $queryFastaFileNodeId = '1438259906372176043';
