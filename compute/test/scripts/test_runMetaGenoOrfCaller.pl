...
test_runMetaGenoOrfCaller.pl - test the runMetaGenoOrfCaller web-service call.

=head1 SYNOPSIS

    USAGE: test_runMetaGenoOrfCaller.pl OPTION LIST HERE
...
This script tests the runMetaGenoOrfCaller web service.
...
my $project = '08020';
my $workSessionId = '';
my $jobName = 'TestMetaGenoOrfCaller';
...
my $program = 'runMetaGenoOrfCaller';
