...
test_getSimpleOrfCallerStatus.pl - test the getSimpleOrfCallerStatus web-service call.

=head1 SYNOPSIS

    USAGE: test_getSimpleOrfCallerStatus.pl OPTION LIST HERE
...
=head1 OPTIONS
 ...
 --taskId       VICS job id as reported by runSimpleOrfCaller

=head1  DESCRIPTION

This script tests the getSimpleOrfCallerStatus web service
...
my $program = 'getSimpleOrfCallerStatus';
...
print SOAP::Lite
    -> service($wsdl_url)
    -> getSimpleOrfCallerStatus(@options);
