...
test_runMetaGenoAnnotation.pl - test the runMetaGenoAnnotation web-service call.

=head1 SYNOPSIS

    USAGE: test_runMetaGenoAnnotation.pl OPTION LIST HERE
...
=head1 OPTIONS
 ...
 --project                  Grid code for submission
 --workSessionId            Work session if desired
 --jobName                  What to call this run
 --inputFastaFileNodeId     VICS id for the input fasta

=head1  DESCRIPTION

This script tests the runMetaGenoAnnotation web service.
...
my $project  = '08020';
my $workSessionId = '';
my $jobName = 'TestMetaGenoAnnotation';
...
my $program = 'runMetaGenoAnnotation';
