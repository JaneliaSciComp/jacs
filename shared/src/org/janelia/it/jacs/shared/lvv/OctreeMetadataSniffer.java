...
public class OctreeMetadataSniffer {
    ...
    private CoordinateToRawTransformFileSource coordinateToRawTransformFileSource;

    public OctreeMetadataSniffer(File topFolder, TileFormat tileFormat, CoordinateToRawTransformFileSource coordinateToRawTransformFileSource) {
        this.topFolder = topFolder;
        this.tileFormat = tileFormat;
        this.coordinateToRawTransformFileSource=coordinateToRawTransformFileSource;
    }
    ...
    public void sniffOriginAndScale() throws DataSourceInitializeException {
        ...
        try {
            CoordinateToRawTransform transform = coordinateToRawTransformFileSource.getCoordToRawTransform(remoteBasePath);
