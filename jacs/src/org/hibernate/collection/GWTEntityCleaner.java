...
public class GWTEntityCleaner {
    ...
    private static boolean classNeedsCleanup(Class objClass) {
        ...
        // do not include java.util as collections need to be inspected further
    ...
    private static Object cleanObject(Object obj, Collection<Integer> visitedObjects, Session session) {
        ...
        // This is the 1st half of this class's heart.
        // Take out Hibernate PeristentCollection wrapper around java.util.Collection
    ...
    private static void cleanEntityPropertyOfGWTIgnorantObjects(String propertyKey, Object propertyValue, Object entity, Collection<Integer> visitedObjects, Session session) {
        ...
        else if ((propertyValue instanceof ParameterVOMapUserType) || (propertyValue instanceof BlastDatabaseFileNode) ||
                (propertyValue instanceof BlastResultFileNode) || (propertyValue instanceof FastaFileNode) ||
                (propertyValue instanceof FileNode)) {
            setProperty(entity, propertyKey, null);
        }
        else {
