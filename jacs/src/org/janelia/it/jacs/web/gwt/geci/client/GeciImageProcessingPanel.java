...
public class GeciImageProcessingPanel extends Composite {
    ...
    private GeciImageProcessingTask _geciImageProcessingTask = new GeciImageProcessingTask();
    ...
    public GeciImageProcessingPanel(String title, org.janelia.it.jacs.web.gwt.common.client.jobs.JobSubmissionListener listener) {
        _listener = listener;
        init(title);
    }
    ...
    private void clear() {
        ...
        _geciImageProcessingTask = new GeciImageProcessingTask();
//        _optionsPanel.displayParams(_geciImageProcessingTask);
    ...
    private void submitJob() {
        ...
        // submit the job
        _geciImageProcessingTask.setJobName(_jobNameTextBox.getText());
        if (projectCodeRequired) {
            ...
            _geciImageProcessingTask.setParameter(Task.PARAM_project, projectCode);
        }
        ...
        _geciImageProcessingTask.setParameter(GeciImageProcessingTask.PARAM_inputFile, _inputFiles);
        _submitButton.setEnabled(false);
        _statusMessage.showSubmittingMessage();
        new SubmitJob(_geciImageProcessingTask, new JobSubmissionListener()).runJob();
    }
