 ...
 */
public class BlastJobResultsPanel extends GeneralJobResultsPanel {
    ...
    private static final int TASK_NAME_COLUMN = 4;
    private static final int NUM_HITS_COLUMN = 5;
    private static final int SUBJECT_COLUMN = 6;
    private static final int ACTIONS_COLUMN = 7;

    public BlastJobResultsPanel(JobSelectionListener jobSelectionListener,
                                JobSelectionListener reRunJobListener, String[] rowsPerPageOptions, int defaultRowsPerPage) {
        super(TASK_BLAST, jobSelectionListener, reRunJobListener, rowsPerPageOptions, defaultRowsPerPage,
                "BlastJobResults");
    }
    ...
    protected Widget createTable(String[] rowsPerPageOptions) {
        ...
        try {
            ...
            _table.addColumn(new TextColumn(TASK_NAME_HEADING));
            ...
            String[][] sortConstants = new String[][]{
                    ...
                    {BlastJobInfo.SORT_BY_PROGRAM, TASK_NAME_HEADING},
            ...
            _logger.error("Problem creating the blast job result table. " + e.getMessage());
        }
    ...
    public void showProgramColumn(boolean showColumn) {
        _table.getCol(4).setVisible(showColumn);
    }

    public void showActionColumn(boolean showColumn) {
        _table.getCol(7).setVisible(showColumn);
    }
    ...
    public class JobDataRetriever implements PagedDataRetriever {
        public void retrieveTotalNumberOfDataRows(final DataRetrievedListener listener) {
            _statusservice.getNumTaskResultsForUser(TASK_BLAST, new AsyncCallback() {
        ...
        public void retrieveDataRows(int startIndex,
            ...
            _statusservice.getPagedBlastTaskResultsForUser(TASK_BLAST, startIndex, numRows, sortArgs, new AsyncCallback() {
                public void onFailure(Throwable caught) {
        ...
        private List formatData(BlastJobInfo[] jobs) {
            ...
            for (final BlastJobInfo job : jobs) {
                ...
                tableRow.setValue(TASK_NAME_COLUMN, new TableCell(job.getProgram()));
    ...
    protected Widget getJobExportMenu(final JobInfo job) {
        ...
        MenuItem zipItem = new MenuItem("Blast results as zip file", true, new Command() {
            public void execute() {
...
//        dropDown.addItem(xmlItem);
    ...
    public static String getLargeBlastResultDownloadLink(BlastJobInfo job) {
        ...
        String originalFileName = "/" + job.getUsername() + "/BlastResults/" + job.getBlastResultFileNodeId() + "/" + blastResultsFileName;
