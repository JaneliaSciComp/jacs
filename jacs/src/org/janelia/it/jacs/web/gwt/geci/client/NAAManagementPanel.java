...
public class NAAManagementPanel extends VerticalPanel {
    ...
    private static final int NAA_NAME_COLUMN    = 1;
    private static final int NAA_PATH_COLUMN    = 2;
    private static final int NAA_DATE_COLUMN    = 3;
    ...
    private TitledPanel _discoveryPanel;
...
//        realize();
    ...
    private void setUpDiscoveryPanel() {
        _discoveryPanel = new TitledPanel("Scan For New Directories");
    ...
    public class UserDataRetriever implements PagedDataRetriever {
        ...
        private List processData(UserDataNodeVO[] naaResults) {
            ...
            for (UserDataNodeVO naaResult : naaResults) {
                ...
                tableRow.setValue(NAA_DELETE_COLUMN,
                        new TableCell(null, createRemoveNodeWidget(naaResult, tableRow)));
                tableRow.setValue(NAA_NAME_COLUMN,
                        new TableCell(naaResult.getNodeName()));
                tableRow.setValue(NAA_PATH_COLUMN, new TableCell(naaResult.getDatabaseObjectId()));
                tableRow.setValue(NAA_DATE_COLUMN,
                        new TableCell(naaResult.getDateCreated()));
    ...
    private class RemoveUserEventHandler implements ClickListener, RemoveNodeListener, PopupListener {
        ...
        public RemoveUserEventHandler(UserDataNodeVO naaResult, TableRow row) {
