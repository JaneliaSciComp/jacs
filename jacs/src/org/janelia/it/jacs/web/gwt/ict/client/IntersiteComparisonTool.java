...
public class IntersiteComparisonTool extends BaseEntryPoint {
    ...
    private IntersiteComparisonToolPanel _intersiteComparisonToolPanel;

    public void onModuleLoad() {
        // Create and fade in the page contents
        clear();
        setBreadcrumb(new Breadcrumb(Constants.JOBS_ICT_LABEL), Constants.ROOT_PANEL_NAME);
...
//    }
    ...
    public Widget getPanel() {
        _intersiteComparisonToolPanel = new IntersiteComparisonToolPanel("Inter-Site Comparison Tool", getTaskIdParam(), new JobSubmittedListener());
        return _intersiteComparisonToolPanel;
    }
...
//            _barcodeDesignerJobResultsPanel.refresh();
    ...
    private class ReRunJobListener implements JobSelectionListener {
        public void onSelect(JobInfo job) {
//            _intersiteComparisonToolPanel.setJob(job.getJobId());
        }
