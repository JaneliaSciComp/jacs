 ...
 */
public class SearchResultsIconMouseManager /* extends MouseListenerAdapter */ implements ClickListener {
    SearchIconPanel _iconPanel;

    public SearchResultsIconMouseManager(SearchIconPanel iconPanel) {
