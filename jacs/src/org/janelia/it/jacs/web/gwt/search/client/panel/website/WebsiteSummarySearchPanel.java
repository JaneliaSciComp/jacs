 ...
 * Time: 10:54:25 AM
 */
public class WebsiteSummarySearchPanel extends CategorySummarySearchPanel {

    public WebsiteSummarySearchPanel(String searchId, String searchQuery) {
        super(searchId, searchQuery);
    }

    protected CategorySearchDataBuilder createDataBuilder(String searchId, String searchQuery) {
        return new WebsiteSearchDataBuilder(searchId, searchQuery);
    }
