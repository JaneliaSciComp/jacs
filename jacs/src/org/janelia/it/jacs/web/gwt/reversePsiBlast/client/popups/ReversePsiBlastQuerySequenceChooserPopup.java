...
package org.janelia.it.jacs.web.gwt.reversePsiBlast.client.popups;
 ...
 */
public class ReversePsiBlastQuerySequenceChooserPopup extends BaseReversePsiBlastPopup {
    private UploadUserSequencePanel _sequencePanel;

    public ReversePsiBlastQuerySequenceChooserPopup(SelectionListener selectionListener, BlastData blastData) {
    ...
    protected void populateContent() {
        ...
        _sequencePanel = new UploadUserSequencePanel(new SequenceSelectionListener(), new SequenceDoubleClickSelectedListener(),
                new String[]{"5", "10", "20"}, getBlastData(), SequenceType.NOT_SPECIFIED, 5);
        add(_sequencePanel);
    }
