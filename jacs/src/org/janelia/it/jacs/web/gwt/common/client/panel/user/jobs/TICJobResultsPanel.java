 ...
 */
public class TICJobResultsPanel extends GeneralJobResultsPanel {
    public TICJobResultsPanel(String taskType, JobSelectionListener jobSelectionListener, JobSelectionListener reRunJobListener, String[] rowsPerPageOptions, int defaultRowsPerPage) {
