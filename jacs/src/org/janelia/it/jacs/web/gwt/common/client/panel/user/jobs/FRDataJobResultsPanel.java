 ...
 * Time: 11:38:01 AM
 */
public class FRDataJobResultsPanel extends GeneralJobResultsPanel {
    public static final String TASK_FR_SAMPLING = "GenomeProjectRecruitmentSamplingTask";
    public FRDataJobResultsPanel(JobSelectionListener jobSelectionListener, JobSelectionListener reRunJobListener,
                                 String[] rowsPerPageOptions, int defaultRowsPerPage) {
        super(TASK_FR_SAMPLING, jobSelectionListener, reRunJobListener, rowsPerPageOptions, defaultRowsPerPage,
                "FRDataJobResults");
    }
