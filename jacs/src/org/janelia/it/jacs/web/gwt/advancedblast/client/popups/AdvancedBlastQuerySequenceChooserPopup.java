 ...
 */
public class AdvancedBlastQuerySequenceChooserPopup extends BaseAdvancedBlastPopup {
    private UploadUserSequencePanel _sequencePanel;

    public AdvancedBlastQuerySequenceChooserPopup(SelectionListener selectionListener, BlastData blastData) {
