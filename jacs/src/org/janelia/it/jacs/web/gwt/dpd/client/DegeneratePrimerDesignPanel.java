 ...
 * @author Todd Safford
 */
public class DegeneratePrimerDesignPanel extends Composite {
    private static Logger _logger = Logger.getLogger("org.janelia.it.jacs.web.gwt.dpd.client.DegeneratePrimerDesignPanel");
    ...
    public DegeneratePrimerDesignPanel(String title, String taskId, org.janelia.it.jacs.web.gwt.common.client.jobs.JobSubmissionListener listener) {
        init(title, taskId);
    }
