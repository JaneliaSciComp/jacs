...
public interface DownloadDAO extends DAO {
     ...
     * @throws DaoException        from called methods
     */
    DataFile createDataFile(String path, String infoLocation, String description, long size, boolean multifileArchive, Set samples)
     ...
     * @throws DaoException        from called methods
     */
    Publication createPublication(String abstractOfPublication, String summary, String title, String subjectDocument, List authors, List rolledUpArchives, List hierarchyRootNodes)
            throws DataAccessException, DaoException;
     ...
     * @throws DaoException        from called methods
     */
    Project createProject(String symbol, String description, List publications)
            throws DataAccessException, DaoException;
     ...
     * @throws DaoException        from called methods
     */
    HierarchyNode createHierarchyNode(String name, String description, List dataFiles, List children)
            throws DataAccessException, DaoException;
