...
public interface XMLSerializer {
     ...
     *
     * @param owner JAXB content object that posesses the ID.
     * @param value The value of the ID.
     * @return Return the value parameter without any modification,
     ...
     *
     * @param fieldName property name of the parent objeect from which 'o' comes.
