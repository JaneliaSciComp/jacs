...
import org.janelia.it.jacs.server.jaxb.reference_record.File;
...
public class FileImpl
        ...
        implements File, RIElement, JAXBObject, UnmarshallableObject, XMLSerializable, ValidatableObject {
    ...
    public UnmarshallingEventHandler createUnmarshaller(UnmarshallingContext context) {
        return new FileImpl.Unmarshaller(context);
    }
                ...
                switch (state) {
                    case 1:
                        if (("description" == ___local) && ("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((FileTypeImpl) FileImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return;
                        }
                        break;
                    case 3:
