...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>HHMI Research Home</title>
        <meta name='gwt:module' content='org.janelia.it.jacs.web.gwt.home.Home'>

        <jsp:include page="/WEB-INF/jsp/common/GWTIncludes.jsp"/>
        <jsp:include page="/WEB-INF/jsp/common/Preferences.jsp">
            <jsp:param name="prefCategoryNames" value="BasePaginatorRowsPerPage,notification"/>
        </jsp:include>
    </head>
    <body>
        <script language="javascript" src="/jacs/gwt/Home/Home.nocache.js"></script>
