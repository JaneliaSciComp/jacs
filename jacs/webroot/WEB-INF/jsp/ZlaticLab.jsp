...
<head>
    <title>Zlatic Lab</title>
    <meta name='gwt:module' content='org.janelia.it.jacs.web.gwt.zlatic.ZlaticLab'>
    ...
    <body>
        <script language="javascript" src="/jacs/gwt/ZlaticLab/ZlaticLab.nocache.js"></script>
