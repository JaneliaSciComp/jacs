...
<head>
    ...
    <meta name='gwt:module' content='org.janelia.it.jacs.web.gwt.dpd.DegeneratePrimerDesign'>
    ...
    <body>
        <script language="javascript" src="/jacs/gwt/DegeneratePrimerDesign/DegeneratePrimerDesign.nocache.js"></script>
