...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml">
    <head>
        ...
        <!-- override standard gsearch styles -->
        <link type="text/css" rel="stylesheet" href="/jacs/css/googlesearch.css"/>
    </head>
    <body>
        <script language="javascript" src="/jacs/gwt/Search/Search.nocache.js"></script>
