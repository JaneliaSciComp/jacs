...
<head>
    <title>BLAST Wizard</title>
    <meta name='gwt:module' content='org.janelia.it.jacs.web.gwt.blast.Blast'>
    ...
    <body>
        <script language="javascript" src="/jacs/gwt/Blast/Blast.nocache.js"></script>
