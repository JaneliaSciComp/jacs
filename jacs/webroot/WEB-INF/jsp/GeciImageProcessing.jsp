...
<head>
    ...
    <meta name='gwt:module' content='org.janelia.it.jacs.web.gwt.geci.GeciImageProcessing'>
    ...
    <body>
        <script language="javascript" src="/jacs/gwt/GeciImageProcessing/GeciImageProcessing.nocache.js"></script>
