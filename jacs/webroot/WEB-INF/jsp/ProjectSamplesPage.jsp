...
%>
        ...
        <!-- We exclude the XHTML declaration for Firefox or else the help link image doesn't size correctly -->
<% } %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml">
	<head>
        ...
        <meta name='gwt:module' content='org.janelia.it.jacs.web.gwt.download.ProjectSamplesPage'>
        ...
        <jsp:include page="/WEB-INF/jsp/common/Preferences.jsp">
            <jsp:param name="prefCategoryNames" value="samples,BasePaginatorRowsPerPage" />
        </jsp:include>
	</head>
	<body>
        <script language="javascript" src="/jacs/gwt/ProjectSamplesPage/ProjectSamplesPage.nocache.js"></script>
