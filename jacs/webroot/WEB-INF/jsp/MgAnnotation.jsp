...
<head>
    <title>Metagenomic Annotation</title>
    <meta name='gwt:module' content='org.janelia.it.jacs.web.gwt.mgAnnot.MgAnnot'>
    <%
    ...
    <body>
        <script language="javascript" src="/jacs/gwt/MgAnnot/MgAnnot.nocache.js"></script>
