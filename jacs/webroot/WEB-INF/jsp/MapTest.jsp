...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- need the VML schema in order for polylines to work in Microsoft IE. -->
	<head>
		<title>Google Maps View</title>

        <meta name='gwt:module' content='org.janelia.it.jacs.web.gwt.map.MapTest'>
        ...
        <jsp:include page="/WEB-INF/jsp/common/Preferences.jsp">
            <jsp:param name="prefCategoryNames" value="BasePaginatorRowsPerPage"/>
        </jsp:include>
    </head>
    <body>
        <script language="javascript" src="/jacs/gwt/MapTest/MapTest.nocache.js"></script>
