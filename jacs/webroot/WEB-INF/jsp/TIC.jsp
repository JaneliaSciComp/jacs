...
<head>
    <title>Transcription Imaging Consortium</title>
    <meta name='gwt:module' content='org.janelia.it.jacs.web.gwt.tic.TIC'>
    ...
    <body>
        <script language="javascript" src="/jacs/gwt/TIC/TIC.nocache.js"></script>
