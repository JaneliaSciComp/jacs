...
<head>
    <title>Eukaryotic Annotation</title>
    <meta name='gwt:module' content='org.janelia.it.jacs.web.gwt.eukAnnot.EukAnnot'>
    ...
    <body>
        <script language="javascript" src="/jacs/gwt/EukAnnot/EukAnnot.nocache.js"></script>
