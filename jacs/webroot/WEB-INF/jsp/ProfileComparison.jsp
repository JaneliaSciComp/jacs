...
<head>
    ...
    <meta name='gwt:module' content='org.janelia.it.jacs.web.gwt.matrix.ProfileComparison'>
    ...
    <body>
        <script language="javascript" src="/jacs/gwt/ProfileComparison/ProfileComparison.nocache.js"></script>
