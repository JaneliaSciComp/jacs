...
<head>
    <title>Barcode Designer and Deconvolution</title>
    <meta name='gwt:module' content='org.janelia.it.jacs.web.gwt.barcode.BarCodeDesigner'>
    ...
    <body>
        <script language="javascript" src="/jacs/gwt/BarcodeDesigner/BarcodeDesigner.nocache.js"></script>
