...
/**
 * @author Todd Safford, Nelson Axelrod
 *         todo All of these generic panels need to have a common base.  All the submission message stuff and listeners
 *         could be shared
 */
public class ProfileComparisonPanel extends Composite {
    ...
    //    private ProfileComparisonTaskOptionsPanel _optionsPanel;
    ...
    private ProfileComparisonTask _comparisonTask = new ProfileComparisonTask();
    ...
    public ProfileComparisonPanel(String title, org.janelia.it.jacs.web.gwt.common.client.jobs.JobSubmissionListener listener) {
        _listener = listener;
        init(title);
    }
    ...
    private void init(String title) {
        ...
        _mainPanel.addActionLink(new HelpActionLink("help", SystemProps.getString("Wiki.Base", "") +
                SystemProps.getString("Wiki.ProfileComparisonHelp", "")));
...
//        _optionsPanel = new ProfileComparisonTaskOptionsPanel();
//        _optionsPanel.setStyleName("AdvancedBlastProgramOptionsPanel");
//        _optionsPanel.displayParams(_comparisonTask);
        ...
        // grid.setWidget(tmpIndex, 1, HtmlUtils.getHtml(ProfileComparisonTask.DISPLAY_NAME, "prompt"));
...
//        contentPanel.add(HtmlUtils.getHtml("&nbsp", "spacer"));
    ...
    private void updateJobNameWidget() {
        _jobNameTextBox.setText("My Profile Comparison job " + new FormattedDate().toString());
    }
    ...
    private void clear() {
        ...
        _comparisonTask = new ProfileComparisonTask();
//        _optionsPanel.displayParams(_comparisonTask);
    ...
    private void submitJob() {
        ...
        // submit the job
        _comparisonTask.setJobName(_jobNameTextBox.getText());
        if (projectCodeRequired) {
            ...
            _comparisonTask.setParameter(Task.PARAM_project, projectCode);
        }
        ...
        _comparisonTask.setParameter(ProfileComparisonTask.PARAM_inputFile, _inputFiles);
        _submitButton.setEnabled(false);
        _statusMessage.showSubmittingMessage();
        new SubmitJob(_comparisonTask, new JobSubmissionListener()).runJob();
    }
