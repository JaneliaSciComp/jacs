 ...
 */
abstract public class BaseReversePsiBlastPopup extends BasePopupPanel {
    private SelectionListener _selectionListener;
    private RoundedButton _applyButton;
    private String _selectedValue;
    private BlastData _blastData;

    protected BaseReversePsiBlastPopup(String title, SelectionListener selectionListener, BlastData blastData) {
