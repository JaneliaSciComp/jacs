 ...
 * Time: 10:11:38 AM
 */
public class FrvNonGridAnnotationOnlyService extends FrvNonGridServiceBase {

    protected void recruit() throws IOException, ParameterException, InterruptedException {
//        Placed in process def
        logger.debug("\nFrvNonGridAnnotationOnlyService recruit started");
        ...
        helper.filterAnnotations();
        logger.debug("\nFrvNonGridAnnotationOnlyService recruit() complete");
    }
