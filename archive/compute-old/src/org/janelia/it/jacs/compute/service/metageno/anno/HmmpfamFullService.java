 ...
 * Time: 2:32:52 PM
 */
public class HmmpfamFullService extends MgAnnoBaseService {
    ...
    public void execute(IProcessData processData) throws ServiceException {
        try {
            ...
            hmmpfamTask.setParameter(HmmpfamTask.PARAM_pfam_db_node_id, hmmpfamFullDbId);
            if (isSubFileMode()) {
...
//            }
            ...
            String hmmpfam2htabStr = "unset PERL5LIB\n" +
                    ...
                    "/" + hmmpfam2HtabCmd + " > " + resultFile.getAbsolutePath() + ".htab";
