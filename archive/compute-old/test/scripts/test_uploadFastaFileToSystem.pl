...
test_uploadFastaFileToSystem.pl - test the uploadFastaFileToSystem web-service call.

=head1 SYNOPSIS

    USAGE: test_uploadFastaFileToSystem.pl OPTION LIST HERE
...
=head1 OPTIONS
 ...
 --pathToFastaFile  The path to the file being uploaded

=head1  DESCRIPTION

This script tests the uploadFastaFileToSystem web service.
...
my $workSessionId = '';
my $pathToFastaFile = '/usr/local/devel/ANNOTATION/jinman/vics_ws_testing/DS234993_single_prot.fsa';
...
my $program = 'uploadFastaFileToSystem';
...
print SOAP::Lite
    -> service($wsdl_url)
    -> uploadFastaFileToSystem(@options);
