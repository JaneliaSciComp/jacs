...
test_getCufflinksStatus.pl - test the getCufflinksStatus web-service call.

=head1 SYNOPSIS

    USAGE: test_getCufflinksStatus.pl OPTION LIST HERE
...
This script tests the getCufflinksStatus web service.
