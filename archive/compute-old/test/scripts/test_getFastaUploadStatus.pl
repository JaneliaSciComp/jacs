...
test_getFastaUploadStatus.pl - test the getFastaUploadStatus web-service call.

=head1 SYNOPSIS

    USAGE: test_getFastaUploadStatus.pl OPTION LIST HERE
...
This script tests the getFastaUploadStatus web service.
...
my $program = 'getFastaUploadStatus';
