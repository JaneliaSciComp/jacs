...
test_getTrnaScanStatus.pl - test the getTrnaScanStatus web-service call.

=head1 SYNOPSIS

    USAGE: test_getTrnaScanStatus.pl OPTION LIST HERE
...
=head1 OPTIONS
 ...
 --taskId       VICS job id for the trnaScan job

=head1  DESCRIPTION

This script tests the getTrnaScanStatus web service.
