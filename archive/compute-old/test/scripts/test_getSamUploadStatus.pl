...
test_getSamUploadStatus.pl - test the getSamUploadStatus web-service call.

=head1 SYNOPSIS

    USAGE: test_getSamUploadStatus.pl OPTION LIST HERE
...
This script tests the getSamUploadStatus web service.
