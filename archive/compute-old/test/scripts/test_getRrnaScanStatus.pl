...
test_getRrnaScanStatus.pl - test the getRrnaScanStatus web-service call.

=head1 SYNOPSIS

    USAGE: test_getRrnaScanStatus.pl OPTION LIST HERE
...
=head1 OPTIONS
 ...
 --taskId       VICS job id assigned to the runRrnaScan job.

=head1  DESCRIPTION

This script tests the getRrnaScanStatus web service.
