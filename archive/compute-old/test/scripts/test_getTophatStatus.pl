...
test_getTophatStatus.pl - test the getTophatStatus web-service call.

=head1 SYNOPSIS

    USAGE: test_getTophatStatus.pl OPTION LIST HERE
...
This script tests the getTophatStatus web service.
