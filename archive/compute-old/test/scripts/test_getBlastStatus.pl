...
test_getBlastStatus.pl - test the getBlastStatus web-service call.

=head1 SYNOPSIS

    USAGE: test_getBlastStatus.pl OPTION LIST HERE
...
This script tests the getBlastStatus web service.
